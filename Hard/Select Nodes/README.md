<h2><a href="https://www.geeksforgeeks.org/problems/select-nodes--170645/1?page=2&category=Dynamic%20Programming&difficulty=Hard&sortBy=submissions">Select Nodes</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given <strong>N&nbsp;</strong>nodes of a tree and a list of edges. Find the minimum number of nodes to be selected to light up all the edges of the tree.<br>
